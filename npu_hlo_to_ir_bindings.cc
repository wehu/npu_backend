...
namespace npu {
    ...
    void NpuHloToIrBindings::EmitBasePointersForHlos(
    ...
    llvm::Value *NpuHloToIrBindings::EmitGetTupleElement(const HloInstruction *gte,
                                                      llvm::Value *base_ptr) {
    ...
    llvm::Value *NpuHloToIrBindings::GetTypedIrValue(const HloInstruction &hlo,
    ...
    void NpuHloToIrBindings::BindHloToIrValue(const HloInstruction &hlo,
                                           llvm::Value *ir_value,
                                           const ShapeIndex &shape_index) {
    ...
    llvm_ir::IrArray NpuHloToIrBindings::GetIrArray(const HloInstruction &hlo,
    ...
    void NpuHloToIrBindings::UnbindAllLocalIrValues() {
