...
#ifndef TENSORFLOW_NPU_HLO_TO_IR_BINDINGS_H
#define TENSORFLOW_NPU_HLO_TO_IR_BINDINGS_H
...
namespace xla {
    namespace npu {
        ...
        class NpuHloToIrBindings {
        public:
            NpuHloToIrBindings(const HloModule &module,
...
#endif //TENSORFLOW_NPU_HLO_TO_IR_BINDINGS_H
